    ...
    <>
        ...
        <div className="mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-[64rem]">
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Prismaを使用したORMで、Supabaseにデプロイされています。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">コンポーネント</h3>
                <p className="text-sm text-muted-foreground">
                  UIコンポーネントはshadcn/uiを使用していて、Tailwind
                  CSSでスタイリングされています。
                </p>
              </div>
            </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">認証</h3>
                <p className="text-sm text-muted-foreground">
                  NextAuth.jsとミドルウェアを使った認証をしています。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">サブスクリプション</h3>
                <p className="text-sm text-muted-foreground flex flex-col">
                  Stripeを使った無料および有料のサブスクリプション管理 　
                  <span>※まだ実装されていません</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="contact" className="container　py-8 md:py-12 lg:py-24">
        <div className="max-w-[58rem] mx-auto text-center flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            もし、webサービスが気に入ったら下記お問い合わせフォームよりご連絡ください
            <br />
            お仕事のご連絡をお待ちしております！
          </p>
          <ContactCard />
